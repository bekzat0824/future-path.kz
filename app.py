...
if submitted:
    if demo_mode:
        ...
        * **Выбранный трек:** International / IT-направление
        * **Рекомендуемые шаги:**
          1. **Подготовка к экзаменам:** Сфокусироваться на профильной математике и физике, цель по ЕНТ — 115+ баллов.
          2. **Языковой сертификаت:** Сдать IELTS на балл не ниже 6.0 для подачи на международные гранты.
          3. **Портфолио:** Участие в хакатонах (например, SPARK Startup Battle) для усиления резюме.
          4. **Целевые вузы:** КБТУ, СДУ, Satbayev University.
        """)
